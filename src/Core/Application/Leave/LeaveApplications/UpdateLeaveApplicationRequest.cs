...
public class UpdateLeaveApplicationRequest : IRequest<DefaultIdType>
{
...
public class UpdateRequestHandler : IRequestHandler<UpdateLeaveApplicationRequest, DefaultIdType>
{
    ...
    public async Task<DefaultIdType> Handle(UpdateLeaveApplicationRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            var leaveType = await _dimensionRepo.FirstOrDefaultAsync(new DimensionByIdSpec(entity.LeaveTypeId), cancellationToken)
