...
public class UpdateVnPowerResultRequest : IRequest<DefaultIdType>
{
...
public class UpdateVnPowerResultRequestHandler : IRequestHandler<UpdateVnPowerResultRequest, DefaultIdType>
{
    // Add Domain Events automatically by using IRepositoryWithEvents
    private readonly IRepositoryWithEvents<VnPowerResult> _repository;
    private readonly IStringLocalizer _t;
    public UpdateVnPowerResultRequestHandler(IRepositoryWithEvents<VnPowerResult> repository, IStringLocalizer<UpdateVnPowerResultRequestHandler> localizer) =>
       (_repository, _t) = (repository, localizer);

    public async Task<DefaultIdType> Handle(UpdateVnPowerResultRequest request, CancellationToken cancellationToken)
    {
