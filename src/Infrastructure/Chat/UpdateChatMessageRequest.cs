...
public class UpdateChatMessageRequestHandler : IRequestHandler<UpdateChatMessageRequest, DefaultIdType>
{
    ...
    private readonly IRepositoryWithEvents<ChatMessage> _repository;
    private readonly IStringLocalizer _t;

    public UpdateChatMessageRequestHandler(IRepositoryWithEvents<ChatMessage> repository, IStringLocalizer<UpdateChatMessageRequestHandler> localizer) =>
